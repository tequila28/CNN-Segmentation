...
class VOCSegmentationDataset(Dataset):
    ...
    def __getitem__(self, index):
        # 读取图像和标签
          image_path = os.path.join('C:/Users/86159/PycharmProjects/FCN语义分割/data/VOCdevkit/VOC2012/JPEGImages', self.images[index]+'.png')
          label_path = os.path.join('C:/Users/86159/PycharmProjects/FCN语义分割/data/VOCdevkit/VOC2012/SegmentationClass', self.lables[index]+'.png')
          #print(image_path)
          #print(label_path)
